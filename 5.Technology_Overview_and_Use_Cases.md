...
Previous Property ID = 0 for a new smart property (or the existing property ID if replacing or appending)
...
Deadline = January 1st, 2215 00:00:00 UTC (must be in the future)
Early bird bonus %/week = 10
